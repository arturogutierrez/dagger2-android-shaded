...
import static dagger2.internal.DaggerCollections.newLinkedHashMapWithExpectedSize;
import static dagger2.internal.Preconditions.checkNotNull;
...
public final class DispatchingAndroidInjector<T> implements AndroidInjector<T> {
    ...
    private final Map<String, Provider2<AndroidInjector.Factory<?>>> injectorFactories;
     ...
     */
    private static <C, V> Map<String, Provider2<AndroidInjector.Factory<?>>> merge(
            Map<Class<? extends C>, V> classKeyedMap, Map<String, V> stringKeyedMap) {
        if (classKeyedMap.isEmpty()) {
            @SuppressWarnings({"unchecked", "rawtypes"})
            Map<String, Provider2<AndroidInjector.Factory<?>>> safeCast = (Map) stringKeyedMap;
            return safeCast;
        }
        ...
        @SuppressWarnings({"unchecked", "rawtypes"})
        Map<String, Provider2<AndroidInjector.Factory<?>>> safeCast = (Map) merged;
    ...
    public boolean maybeInject(T instance) {
        Provider2<AndroidInjector.Factory<?>> factoryProvider =
